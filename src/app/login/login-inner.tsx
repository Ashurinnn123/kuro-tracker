...
// Client component for form with Turnstile
"use client"
...
function LoginForm({ error, message }: { error?: string; message?: string }) {
...
// Server component – awaits searchParams and passes to client form
